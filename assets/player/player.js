    ...
    var _ = {
        ...
        init: function (options) {
            ...
            var template = ['<svg viewBox="0 0 100 100" id="playable" version="1.1" xmlns="http://www.w3.org/2000/svg" width="34" height="34" data-play="playable" class="not-started playable">',
                ...
                '<line x1="40" y1="35" x2="40" y2="65" stroke="#ff0057" fill="none" stroke-width="8" stroke-linecap="round"/>',
                '<line x1="60" y1="35" x2="60" y2="65" stroke="#ff0057" fill="none" stroke-width="8" stroke-linecap="round"/>',
                '</g>',
